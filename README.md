...
## S2O
This is a custom fork used for [S2O](https://github.com/3dlg-hcvc/s2o). The methods supported by this work are FPNGroup and FPNGroupMot. The instructions for training and inference remain similar to the ones for the original repo, below.
